                            ...
                            <div class="card-body p-4">
                                ...
                                <div class="p-2 mt-4">
                                    <form action="{{route('login.show')}}" method="POST">
                                        ...
                                        <div class="mb-3">
                                            <div class="float-end">
                                                <a href="{{route('emailverify')}}" class="text-muted">Forgot password?</a>
                                            </div>
                                            <label class="form-label" for="password-input">Password</label>
                                            <div class="position-relative auth-pass-inputgroup mb-3">
                                                <input type="password" class="form-control pe-5" placeholder="Enter password" name="password" value="{{old('password')}}" id="password-input">
