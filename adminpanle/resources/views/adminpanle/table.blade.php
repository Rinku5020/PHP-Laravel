                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                <h4 class="mb-sm-0">Data Table</h4>
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            ...
                            <a href="{{route('form.create')}}" class="btn btn-primary">Add User</a>
                                </div>
                                <div class="card-body table-responsive">
                                        ...
                                        <form id="bulkdelete">
                                                ...
                                                <tbody>
                                                    @foreach ($table as $user)
                                                        <tr data-id="{{ $user->id }}">
                                                            ...
                                                            <td>{{ $user->gender }}</td>
                                                            <td>{{ $user->hobbies }}</td>
                                                            <td><img src="{{ asset('uploads/' . $user->image) }}" width="50" height="50"></td>
                                                            <td><a href="{{ route('table.edit', $user->id) }}" class="btn btn-primary mt-2">Edit</a></td>
                                                            <td>
                                                                <form action="{{ route('table.destroy', $user->id) }}" method="POST" class="delete-form">
                                                                    @csrf
                                                                    @method('DELETE')
                                            ...
                                            <button type="submit" class="btn btn-danger mb-3" id="bulkDeleteBtn">Delete Selected</button>
                                        </form>
