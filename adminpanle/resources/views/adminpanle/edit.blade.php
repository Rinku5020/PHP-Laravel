                                            ...
                                            <div class="tab-pane fade" id="pills-info-desc" role="tabpanel"
                                                ...
                                                <div>
                                                    ...
                                                    <div class="row mt-3 ">
                                                        ...
                                                        @php
                                                        $hobbiesSelect = old('hobbies', explode(',', $user->hobbies));
                                                       @endphp
                                                        <div class="col-lg-6">
                                                            ...
                                                            <div class="form-check">
                                                                <input class="form-check-input" type="checkbox"
                                                                    ...
                                                                    name="hobbies[]"
                                                                    {{ in_array('playing', $hobbiesSelect) ? 'checked' : '' }}>
                                                                <label class="form-check-label"
                                                            ...
                                                            <div class="form-check">
                                                                <input class="form-check-input" type="checkbox"
                                                                    ...
                                                                    name="hobbies[]"
                                                                    {{ in_array('traveling', $hobbiesSelect) ? 'checked' : '' }}>
                                                                <label class="form-check-label"
                                                            ...
                                                            <div class="form-check">
                                                                <input class="form-check-input" type="checkbox"
                                                                    ...
                                                                    name="hobbies[]"
                                                                    {{ in_array('reading', $hobbiesSelect) ? 'checked' : '' }}>
                                                                <label class="form-check-label"
                                                    ...
                                                    <div class="row mt-4">
                                                        <div class="col-lg-6">
                                                            ...
                                                            <textarea class="form-control" id="address-input" placeholder="Enter Address" rows="2" name="address">{{ old('address', $user->address) }}</textarea>
                                                            @error('address')
                                                                <div class="text-danger">{{ $message }}</div>
                                                            @enderror
                                                        ...
                                                        <div class="col-lg-6">
                                                            ...
                                                            <input type="date" class="form-control" name="dob"
                                                                value="{{ old('dob', $user->dob) }}" id="dob-input">
                                                            @error('dob')
                                                                <div class="text-danger">{{ $message }}</div>
                                                            @enderror
                                                        </div>
                                            ...
                                            <div class="tab-pane fade" id="pills-success" role=""
                                                ...
                                                <div>
                                                    ...
                                                    <div class="col-6">
                                                        ...
                                                        <img src="{{ asset('uploads/' . $user->image) }}"  alt="" class="img-fluid mt-4"
                                                            id="preview-pic"
