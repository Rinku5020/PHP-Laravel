                        ...
                        <div class="col-xl-6 mx-auto ">
                            <div class="card">
                                ...
                                <div class="card-body form-steps">
                                    <form class="row g-3" action="{{route('changepassword')}}" method="post">
                                        @csrf
                                        @auth
                                        <div class="col-md-6">
                                            <label for="validationDefault01" class="form-label">First name</label>
                                            <input type="text" class="form-control" id="validationDefault01" value="{{ auth()->user()->first_name }}" disabled>
                                        </div>
                                        <div class="col-md-6">
                                            <label for="validationDefault02" class="form-label">Last name</label>
                                            <input type="text" class="form-control" id="validationDefault02" value="{{ auth()->user()->last_name }}" disabled>
                                        </div>
                                        <div class="col-md-12">
                                            <label for="validationDefault02" class="form-label">Email</label>
                                            <input type="email" class="form-control" id="validationDefault02" value="{{auth()->user()->email}}" disabled>
                                        </div>
                                        @endauth
                                        <div class="col-md-12">
                                            <button type="button" class="btn btn-danger" data-bs-toggle="collapse" data-bs-target="#passwordFields">
                                                Change Password
                                            </button>
                                        </div>

                                        <div id="passwordFields" class="collapse row g-3">
                                                <div class="col-md-6">
